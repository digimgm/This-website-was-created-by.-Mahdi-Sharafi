<html class="js">
 <head> 
  ...
  <meta property="og:title" content="✨دیجی فرم | ایجاد حرفه ای انواع فرم"> 
  ...
  <!--<meta property="og:site_name" content="SyncStar">--> 
  <!--        <meta property="og:type" content="website">--> 
  <meta property="og:url" content="https://digi-form.ir/"> 
  <link rel="shortcut icon" href="https://digi-form.ir/home_files/logo.png" type="image/png"> 
  <title>Digi Form | دیجی فرم
        </title> 
  <link type="text/css" rel="stylesheet" href="/home_files/css_R-slMEj6rJBamqClUE8NGYB_qxwBfAW582ITDGL3RBQ.css" media="all"> 
  <link type="text/css" rel="stylesheet" href="/home_files/css_JPobExmHoM2UPKYc0PlYX1vt50leELzRYvBNRdS4pns.css" media="all"> 
  <link type="text/css" rel="stylesheet" href="/home_files/css_UzGCa866iQKeXmL_n14yTKXRZzTCghHa9OwYkNYyL_w.css" media="all"> 
  <link type="text/css" rel="stylesheet" href="/home_files/css_31ewjgIi4GLqmbZLs02IAxlJu1reKKAKV3Rhbe2pJTE.css" media="all"> 
  <link type="text/css" rel="stylesheet" href="/home_files/font-awesome.css" media="all"> 
  ...
  <link type="text/css" rel="stylesheet" href="/home_files/css_9W884IzJCD9DKS3_v5QvIDzKiPOpOYxNGTcjcT3cfD8.css" media="all"> 
  <!-- --> 
  <script type="text/javascript" src="/home_files/js_WkOMkSyjg9rxsesVK2mUAVX_dhZTWbIE6jpIzuL-ygM.js">
        </script> 
  <script type="text/javascript" src="/home_files/js_QYglOhI3S2SbNpGldeREGKgoLiaz6Fs9ZTgOyQnLz90.js">
        </script> 
  <script type="text/javascript" src="/home_files/js_kRjuk9ZzQidKjkbOVFC6nt3Odr2EV5tqTmGKlrWth0Q.js">
        </script> 
  <script type="text/javascript" src="/home_files/js_wH3ppKt1Jjso1Q3qF_tYu-Jqqj3Mwqqldt7Ltltr1gU.js">
        </script> 
  <script type="text/javascript" src="/home_files/js_gujzNaGnEn25mpPx0X3XbZtYaJRY8DAcqbLYpQhhjiE.js">
        </script> 
  <!-- --> 
  <!--        <link href="https://client.relay.crisp.chat/" rel="preconnect" crossorigin="">
                <link href="https://client.crisp.chat/" rel="preconnect" crossorigin="">
                <link href="https://image.crisp.chat/" rel="preconnect" crossorigin="">--> 
  <!-- --> 
  <!--<link href="/home_files/client_default.css" type="text/css" rel="stylesheet">--> 
 </head> 
 <body class="html front not-logged-in no-sidebars page-home rtl wide dexp-xs" keybinderlisteneradded="true" style=""> 
  <div id="skip-link"> 
   <a href="#main-content" class="element-invisible element-focusable">رفتن به محتوای اصلی </a> 
  </div> 
  <div class="dexp-body-inner front">
   <section class="dexp-section" id="section-header"> 
    <div class="container"> 
     <div class="row">
      <h1 class="title element-invisible" id="page-title"> </h1> 
      <div class="hidden-lg hidden-md"> 
       <span class="fa fa-bars fa-2x dexp-menu-toggle"> </span> 
      </div> 
      <div class="dexp-logo col-xs-12 col-sm-12 col-md-2 col-lg-2 pull-right text-left"> 
       <a class="site-logo" href="/"> <img src="/home_files/logo.png" alt="" height="65" width="65"> </a> 
      </div> 
      <div class="region region-second-nav col-xs-12 col-sm-12 col-md-3 col-lg-3"> 
